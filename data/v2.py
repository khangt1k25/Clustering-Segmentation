...
def ShearX(pair, v, seed):  # [-0.3, 0.3]
    assert -0.3 <= v <= 0.3
    if seed >= 0.75:
        v = -v
...
def ShearY(pair, v, seed):  # [-0.3, 0.3]
    assert -0.3 <= v <= 0.3
    if seed >= 0.75:
        v = -v
...
def TranslateX(pair, v, seed):  # [-150, 150] => percentage: [-0.45, 0.45]
    assert -0.45 <= v <= 0.45
    if seed >= 0.75:
        v = -v
    img, _ = pair
...
def TranslateY(pair, v, seed):  # [-150, 150] => percentage: [-0.45, 0.45]
    assert -0.45 <= v <= 0.45
    if seed >= 0.75:
        v = -v
    img, _ = pair
